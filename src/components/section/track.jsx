...
import {animateTextAndTrack} from "../../animation/trackAnimation.js";
...
export default function Track() {
    ...
    useEffect(() => {
        if (isInView) {
            animateTextAndTrack(svgRef, textRef);
        }
    }, [isInView]);

    return (
        <section className="py-16 bg-white-900/80">
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <h2
                            ref={textRef}
                            className="text-3xl md:text-4xl font-bold text-black-800 mb-4 opacity-0"
                        >
                            Auto Rental
                        </h2>
                        <p

                            className="text-md text-black-600 max-w-2xl mx-auto">
                            All cars are in ideal condition and ready to rent.
                        </p>
                    </div>
                    <div className="md:grid-cols-2 gap-8 items-center">
                        <div className="relative h-64 md:h-70 flex items-center justify-center bg-white p-4">
                            <svg ref={svgRef} viewBox="0 0 304 112" className="w-full h-full">
                                <title>track</title>
